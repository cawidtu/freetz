...
$(PKG)_REUSEPORT:=$(if $(FREETZ_KERNEL_VERSION_3_10_MIN),ON,OFF)

$(PKG)_PATCH_POST_CMDS += $(SED) -i "s/SO_REUSEPORT support\" ON/SO_REUSEPORT support\" $($(PKG)_REUSEPORT)/g" CMakeLists.txt; 
